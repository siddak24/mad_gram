...
class RuntimeManager {
    ...
    constructor(telemetryServerUrl, manageHealth, projectRoot, processManager) {
    ...
    static async create(options) {
        const manager = new RuntimeManager(options.telemetryServerUrl, options.manageHealth ?? true, options.projectRoot, options.processManager);
